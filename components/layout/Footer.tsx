  ...
  return (
    <footer className="bg-bark text-white">
      <div className="container-custom py-12 md:py-16">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12">
          <div>
            ...
            <p className="text-mist leading-relaxed">
              A premier event venue in Bacolod City offering elegant spaces for
              weddings, debuts, birthdays, and corporate events in a lush
              garden setting.
            </p>
          </div>
        ...
        <div className="border-t border-sage mt-8 pt-8 text-center text-mist text-sm">
          <p>
            &copy; {currentYear} Uptown Garden Venue & Catering. All rights
            reserved.
          </p>
        </div>
      </div>
